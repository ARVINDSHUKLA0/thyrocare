      ...
      <div className="about-grid">
        <div className="about-text-col">
          ...
          <div className="about-body-text">
            <p>
              Your health deserves the right care at the right time. Get reliable health checkups and diagnostic tests designed to help you understand your health better
            </p>
            <p>
              From routine health screenings to comprehensive full-body checkups, choose from carefully designed packages that make preventive healthcare simple, convenient, and accessible.
            </p>
            <p>
              Book your health test with ease and take a proactive step towards a healthier future. Because knowing your health today can help you make better choices for tomorrow.
            </p>
          </div>
